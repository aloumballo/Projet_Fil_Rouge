 ...
 */
final class Version20220630201306 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE burger DROP user_id, DROP gestionnaire_id');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE burger ADD user_id INT DEFAULT NULL, ADD gestionnaire_id INT DEFAULT NULL');
